...
{/* <Box aborderRadius={"full"} bg={"violet.300"} rounded={"full"} size={"2"}></Box>*/}
      ...
      <Box w="56"  h="20">
        ...
        <Text fontWeight={"bold"}   fontSize={"22"} noOfLines={1}>Dave Jhaeson Alivio</Text>
        <Text alignSelf={"baseline"} color={"gray.600"} >You: Sml sir?</Text>
        <Box  mt={3} w="32" h="4" bg="violet.600"  alignSelf={"center"} rounded="full"> 
      ...
      <Box h={"16"} w={"16"} alignItems={"center"}>
        ...
        <Box borderRadius={"full"} bg={"violet.300"} rounded={"full"}  size={"2"}></Box>
      ...
      <Box w="56"  h="20">
        ...
        <Text fontWeight={"bold"}   fontSize={"22"} noOfLines={1}>Eivoryl</Text>
        <Text alignSelf={"baseline"} color={"gray.600"} >I want her back.</Text>
        <Box  mt={3} w="32" h="4" bg="red.600"  alignSelf={"center"} rounded="full"> 
      ...
      <Box w="56"  h="20">
        ...
        <Text fontWeight={"bold"}   fontSize={"22"} noOfLines={1}>Ocao</Text>
        <Text alignSelf={"baseline"} color={"gray.600"} >are predator laptop still on stock?</Text>
        <Box  mt={3} w="32" h="4"alignSelf={"center"} rounded="full" borderColor={"red.600"} borderWidth={"1"}> 
      ...
      <Box w="56"  h="20">
        ...
        <Text fontWeight={"bold"}   fontSize={"22"} noOfLines={1}>Kitler</Text>
        <Text alignSelf={"baseline"} color={"gray.600"} isTruncated maxW={"250"} w={"90%"}>Meow meow meoew? Meow Nyah nyah.</Text>
        <Box  mt={3} w="32" h="4" bg="violet.600"  alignSelf={"center"} rounded="full"> 
        <Text fontSize={"11"} alignSelf={"center"} color={"white"}>Order/s Confirmed</Text>
        </Box>
      </Box>
      ...
      <Box w="56"  h="20">
        ...
        <Text fontWeight={"bold"}   fontSize={"22"} noOfLines={1}>Kenn & Ken</Text>
        <Text alignSelf={"baseline"} color={"gray.600"} >Milktea in stock rn?</Text>
        <Box  mt={3} w="32" h="4" bg="violet.600"  alignSelf={"center"} rounded="full"> 
        <Text fontSize={"11"} alignSelf={"center"} color={"white"}>Order/s Confirmed</Text>
        </Box>
      </Box>
      ...
      <Box w="56"  h="20">
        ...
        <Text fontWeight={"bold"}   fontSize={"22"} noOfLines={1}>Mark Villar</Text>
        <Text alignSelf={"baseline"} color={"gray.600"} >Tahimik lng ako.</Text>
        <Box  mt={3} w="32" h="4" bg="violet.600"  alignSelf={"center"} rounded="full"> 
        <Text fontSize={"11"} alignSelf={"center"} color={"white"}>Order/s Confirmed</Text>
        </Box>
      </Box>
